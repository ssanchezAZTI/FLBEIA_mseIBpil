...
for (cs in scenario_list){
  ...
  # load file
  obj <- loadToEnv( file.path("temporal_output/output_scenarios",paste("results2018_",cs,".RData",sep="")))[["out.bio"]]
...
# Save data
save( dat.bio.q, file="temporal_output/res_bio_all2018.RData")
rm( cs, dat.bio.q)
...
for (cs in scenario_list){
  ...
  # load file
  obj <- loadToEnv( file.path("temporal_output/output_scenarios",paste("results2018_",cs,".RData",sep="")))[["out.flt"]]
...
# Save data
save( dat.eco.q, file="temporal_output/res_eco_all2018.RData")
...
for (cs in scenario_list){
  ...
  # load file
  obj <- loadToEnv( file.path("temporal_output/output_scenarios",paste("results2018_",cs,".RData",sep="")))[["out.adv"]]
...
# Save data
save( dat.adv.q, file="temporal_output/res_adv_all2018.RData")
...
#   
#   # load file
#   obj <- loadToEnv( file.path("temporal_output/output_scenarios",paste("results2018_",cs,".RData",sep="")))[["out.risk"]]
#   
